...
$query="insert into tbBill(fdBillTypeID,fdFromOrgID,fdToOrgID,fdAuditOrgID,fdStatus,fdPayment,fdCreate,fdCreateOrgID) values({$billtype},{$from},{$to},0,0,0,'{$create}',{$GLOBALS["orgid"]})";
